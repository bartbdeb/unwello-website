// Generated from thailand_jci_hospital_database_7.xlsx (tabs 1-4: JCI Hospital
// Database, Hospital Specialties, Hospital Procedures, Hospital-Specialty Map).
...
// specialties = real specialty slugs from the authoritative Hospital-Specialty
// Map (tab 4) — NOT keyword-guessed from free text. This is what connects a
// hospital to a Treatment Category page.
...
export const hospitals: Hospital[] = [
  ...
  },
  {
    ...
    "allCategoriesRaw": [
      ...
      "Fertility & IVF",
      "Physiotherapy, Rehab & Sports Medicine",
      "Traditional Thai Medicine & Medical Spa"
    ],
    "otherAccreditations": [
  ...
  {
    "hospitalId": "H032",
    "slug": "umc-digital-ai-petct-center",
  ...
  },
  {
    ...
    "city": "Koh Samui (Surat Thani)",
    "approved": false,
    "certified": false,
    "fame": 0,
    "jciProgramType": "Hospital Program",
    "jciSince": "2012 (per third-party sources; confirm exact date via JCI directory)",
    "ccpc": [],
    "specialties": [
      "cardiology",
      "orthopedics",
