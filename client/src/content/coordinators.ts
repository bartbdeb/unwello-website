...
export const coordinators: Coordinator[] = [
  {
    ...
    tagline: 'Hospitality leadership and medical aesthetics business experience, based in Thailand since 2017.',
    bio: [
      ...
      'Before that, he spent several years in insurance brokerage in Thailand, first as a consultant and later as Managing Director — experience that gives him a practical understanding of how cross-border health and travel insurance actually works, which comes up often when patients ask what their policy will and won\'t cover.',
  ...
  },
  {
    ...
    tagline: 'Healthcare supply-chain and logistics background, including pharmaceutical cold-chain and vaccine distribution.',
    bio: [
      "Before founding Hospigo, Bart managed contract logistics operations specifically for the healthcare sector in the Netherlands — overseeing warehousing and distribution for major pharmaceutical clients and a national COVID-19 vaccine distribution program. That meant directing temperature-controlled logistics across multiple ranges, from -80°C to room temperature, while holding 100% product integrity for sensitive vaccines and medicines under strict Good Distribution Practice (GDP) and Good Manufacturing Practice (GMP) standards, with full budget and P&L accountability for the operation.",
